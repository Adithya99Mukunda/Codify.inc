import {
  ...
  const features = [
    ...
    {
      icon: FaUserTie,
      title: "Taught by a Developer",
      points: [
        "Learn from someone who actually writes code",
        "No generic theory — real insights",
        "Guidance from client experiences",
        "Understand how real teams work",
        "Ask industry questions & get answers"
      ]
    }
  ];
  ...
  const UniqueSection = () => {
    return (
      <section className="py-5" style={{ background: "linear-gradient(to bottom, #fffef2, #f7f8f4)" }}>
