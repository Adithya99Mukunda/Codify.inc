            ...
            <div className="col-md-8">
              <div className="p-4 rounded shadow-lg">
                <p>
                  ...
                  passionate about designing user-first experiences. With 4
    ...
    <div className="row g-4">
      ...
      <div className="col-md-4 h-100">
        ...
        >
          ...
          <div className="card-body">
            <h5 className="card-title fw-bold">Dubai Tourism Dashboard</h5>
            <p className="text-muted small mb-1">
              <strong>Role:</strong> React UI Developer
            </p>
            <p className="small text-dark">
              Delivered responsive dashboards for both a 5760×1080 command
              center display and iPad controllers. Handled conditional rendering
              for multi-device UI under tight deadlines.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="col-md-4 h-100">
        ...
        >
          <div className="card h-100 shadow-md p-3 project-card">
            ...
            />
            <div className="card-body">
              <h5 className="card-title fw-bold">AiEducator – EdTech Platform</h5>
              <p className="text-muted small mb-1">
                <strong>Role:</strong> Frontend Developer (React.js)
              </p>
              <p className="small text-dark">
                Developed dynamic UI components for personalized learning
                experiences. Integrated AI-driven math modules and optimized
                performance using code splitting and lazy loading.
              </p>
            </div>
          </div>
        </a>
      ...
      <div className="col-md-4 h-100">
        ...
        >
          ...
          />
          <div className="card-body">
            <h5 className="card-title fw-bold">WK Case Laws – Legal Dashboard</h5>
            <p className="text-muted small mb-1">
              <strong>Role:</strong> React Developer
            </p>
            <p className="small text-dark">
              Built a legal analytics dashboard for an American law firm using
              React. Focused on clean UI structuring, reusable components, and
              seamless data rendering from case law APIs.
            </p>
          </div>
        </div>
      </div>
        ...
        >
          <div className="card h-100 shadow-md p-3 project-card">
            ...
            <div className="card-body">
              ...
              <p className="small text-dark">
                Delivered scalable UI components for Arcadia’s clean energy
                platform, enabling seamless user experience across desktop and
                mobile. Focused on responsive dashboards, API-driven data
                visuals, and optimized accessibility for solar and utility
                account management.
              </p>
            </div>
          </div>
        ...
        >
          <div className="card h-100 shadow-md p-3 project-card">
            ...
            <div className="card-body">
              ...
              <p className="small text-dark">
                Developed a comprehensive environmental dashboard for Loughs
                Agency, focusing on data visualization and user engagement.
                Implemented responsive design principles to ensure accessibility
                across devices, enhancing public interaction with environmental
                data.
              </p>
            </div>
          </div>
        ...
        >
          <div className="card h-100 shadow-md p-3 project-card">
            ...
            <div className="card-body">
              ...
              <p className="small text-dark">
                Enhanced user engagement by 30% through a redesigned platform
                for Dr. Reddy Laboratories. Focused on creating responsive,
                accessible interfaces that improved navigation and usability for
